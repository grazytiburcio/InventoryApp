...
public class BookProvider extends ContentProvider {
    ...
    static {
        ...
        // The content URI of the form "content://com.example.grazy.inventoryapp/books" will map to the
        ...
        // For example, "content://com.example.grazy.inventoryapp/books/3" matches, but
        // "content://com.example.grazy.inventoryapp/books" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case BOOK_ID:
                ...
                // For an example URI such as "content://com.example.grazy.inventoryapp/books/3",
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        // uri: content://com.example.grazy.inventoryapp/books
